    ...
    <div className="min-h-screen bg-neutral-50">
      <section className="relative px-6 pt-32 pb-20 md:pt-40 md:pb-28">
        <div className="mx-auto max-w-2xl">
          <h1 className="mb-8   tracking-[0.02em] text-neutral-900 leading-[1.15] md:text-6xl">
            Rates
          </h1>
          <p className="mb-12   tracking-[0.01em] text-neutral-700 leading-[1.85]">
            Every figure on this page exists to protect one idea: you never have to explain yourself twice.
          </p>
          <p className="mb-6   tracking-[0.01em] text-neutral-700 leading-[1.85]">
      ...
      <section className="px-6 pb-16">
        <div className="mx-auto max-w-2xl">
          <button
            ...
            className="group relative inline-flex items-center gap-3 bg-neutral-900 px-8 py-4   tracking-[0.03em] text-neutral-50 transition-all duration-500 hover:bg-neutral-800"
            style={{
      ...
      >
        <section className="border-t border-neutral-200 px-6 py-16">
          <div className="mx-auto max-w-2xl">
            <div className="mb-10">
              <p className="mb-3   uppercase tracking-[0.08em] text-neutral-500">
                Tier One
              </p>
              <h2 className="mb-4   tracking-[0.01em] text-neutral-900  md:text-4xl">
                New Clients / Trial Engagements
              </h2>
              <p className="  italic tracking-[0.02em] text-neutral-600">
            ...
            <div className="mb-10 space-y-6">
              <div className="flex items-baseline justify-between border-b border-neutral-200 pb-3">
                <span className="text-base  text-neutral-700">Overnight (up to 14 hours)</span>
                <span className="  tracking-[0.02em] text-neutral-900">$25,000</span>
              </div>
              <div className="flex items-baseline justify-between border-b border-neutral-200 pb-3">
                <span className="text-base  text-neutral-700">24 Hours</span>
                <span className="  tracking-[0.02em] text-neutral-900">$45,000</span>
              </div>
              <div className="flex items-baseline justify-between border-b border-neutral-200 pb-3">
                <span className="text-base  text-neutral-700">48 Hours</span>
                <span className="  tracking-[0.02em] text-neutral-900">$75,000</span>
              </div>
            </div>
            <p className="mb-6   tracking-[0.01em] text-neutral-700 leading-[1.85]">
            ...
            <p className="  italic tracking-[0.01em] text-neutral-600 ">
        ...
        <section className="border-t border-neutral-200 bg-gradient-to-b from-transparent to-neutral-100/30 px-6 py-16">
          <div className="mx-auto max-w-2xl">
            ...
            <div className="mb-10 space-y-6">
              <div className="flex items-baseline justify-between border-b border-neutral-200 pb-3">
                <span className="text-base  text-neutral-700">Overnight (up to 14 hours)</span>
                <span className="  tracking-[0.02em] text-neutral-900">$28,000</span>
              </div>
              <div className="flex items-baseline justify-between border-b border-neutral-200 pb-3">
                <span className="text-base  text-neutral-700">24 Hours</span>
                <span className="  tracking-[0.02em] text-neutral-900">$50,000</span>
              </div>
              <div className="flex items-baseline justify-between border-b border-neutral-200 pb-3">
                <span className="text-base  text-neutral-700">48 Hours</span>
                <span className="  tracking-[0.02em] text-neutral-900">$80,000</span>
              </div>
            </div>
            <p className="mb-6   tracking-[0.01em] text-neutral-700 leading-[1.85]">
            ...
            <p className="  tracking-[0.01em] text-neutral-700 leading-[1.85]">
        ...
        <section className="border-t border-neutral-200 bg-gradient-to-b from-neutral-100/30 to-transparent px-6 py-16">
          <div className="mx-auto max-w-2xl">
            <div className="mb-10">
              ...
              <p className="  italic tracking-[0.02em] text-neutral-600">Annual Retainer</p>
            </div>
            <div className="mb-10 border-b border-neutral-300 pb-6">
              <p className="text-2xl  tracking-[0.02em] text-neutral-900">
                $240,000 <span className="text-base text-neutral-600">annually</span>
              </p>
            </div>
            <div className="mb-10">
              <p className="mb-4   uppercase tracking-[0.04em] text-neutral-600">
                Includes
              </p>
              <ul className="space-y-4   tracking-[0.01em] text-neutral-700 leading-[1.85]">
        ...
        <section className="border-t border-neutral-200 px-6 py-16">
          <div className="mx-auto max-w-2xl">
            <h2 className="mb-10   tracking-[0.01em] text-neutral-900  md:text-4xl">
              The Rationale
            </h2>
            ...
            <p className="mt-10   italic tracking-[0.01em] text-neutral-700 leading-[1.85]">
          ...
          <div className="mx-auto max-w-2xl">
            ...
            <div className="border-t-2 border-neutral-300 pt-6">
              <div className="mb-2 flex items-baseline justify-between">
                ...
                <span className="  text-neutral-900">$28,000–$56,000</span>
              </div>
              <div className="flex items-baseline justify-between">
                <span className="text-base  text-neutral-700">Rate charged</span>
                <span className="  text-neutral-900">$45,000–$50,000</span>
              </div>
            </div>
            <p className="mt-8 text-base  tracking-[0.02em] text-neutral-900">The math holds.</p>
          </div>
        </section>

        <section className="border-t border-neutral-200 px-6 py-16">
          <div className="mx-auto max-w-2xl">
            <h2 className="mb-8   tracking-[0.01em] text-neutral-900  md:text-4xl">
              Availability
            </h2>
            <p className="mb-6   tracking-[0.01em] text-neutral-700 leading-[1.85]">
              I maintain a limited client roster. New partnerships are reviewed quarterly and only when an existing one concludes.
            </p>
            <p className="  italic tracking-[0.01em] text-neutral-700 leading-[1.85]">
          ...
          <div className="mx-auto max-w-2xl">
            ...
            <div className="space-y-6">
              <div className="border-b border-neutral-200 pb-4">
                <p className="mb-2 text-base  text-neutral-900">Bay Area / Northern California</p>
                <p className="  text-neutral-600">No fee.</p>
              </div>
              <div className="border-b border-neutral-200 pb-4">
                <p className="mb-2 text-base  text-neutral-900">West Coast (LA, Seattle, Portland, San Diego)</p>
                <p className="  text-neutral-700">
                  Overnight $28,000 / 24 hours $50,000 + first-class travel and accommodation.
                </p>
              </div>
              <div className="border-b border-neutral-200 pb-4">
                <p className="mb-2 text-base  text-neutral-900">National (NYC, Miami, Chicago, Austin)</p>
                <p className="  text-neutral-700">
                  24 hours $55,000 / 48 hours $80,000 + first-class travel and accommodation.
                </p>
              </div>
              <div className="pb-4">
                <p className="mb-2 text-base  text-neutral-900">International</p>
                <p className="  text-neutral-600">By arrangement.</p>
              </div>
            </div>
            <p className="mt-10   italic tracking-[0.02em] text-neutral-700">
        ...
        <section className="border-t border-neutral-200 px-6 py-16">
          <div className="mx-auto max-w-2xl">
            ...
            <div className="mb-8 border-l-2 border-neutral-300 pl-6">
              <p className="mb-3   tracking-[0.01em] text-neutral-700 leading-[1.85]">
                I also accept Amex, with the following policy:
              </p>
              <p className="mb-2   tracking-[0.01em] text-neutral-600 ">
                For Amex transactions exceeding $10,000, a 3% processing fee applies.
              </p>
              <p className="  tracking-[0.01em] text-neutral-600 ">
      ...
      <section className="border-t border-neutral-200 px-6 py-20">
        <div className="mx-auto max-w-2xl">
          <p className="mb-4 text-xl  tracking-[0.01em] text-neutral-900  md:text-2xl">
            I don't sell time.
          </p>
          <p className="text-xl  tracking-[0.01em] text-neutral-700  md:text-2xl">
