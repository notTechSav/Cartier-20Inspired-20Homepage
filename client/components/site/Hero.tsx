...
const Hero = () => {
  ...
  return (
    <section className="relative isolate flex min-h-screen w-full overflow-hidden bg-luxury-black">
      ...
      <div className="relative z-10 flex w-full flex-1 flex-col items-start justify-end px-8 pb-24 pt-32 lg:items-center lg:justify-center lg:pb-32">
        <div className="flex w-full max-w-luxury flex-col items-start gap-8 text-luxury-white mb-[23px] lg:mb-0">
