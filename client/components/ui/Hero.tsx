  ...
  return (
    <section className="relative isolate flex min-h-screen w-full overflow-hidden bg-luxury-black">
      ...
      <button
        ...
        className="absolute left-8 top-8 inline-flex items-center justify-center gap-2 rounded-[2px] border border-white/60 bg-white/85 px-5 py-3 uppercase tracking-uppercase text-luxury-black shadow-luxury-sm backdrop-blur transition-all duration-250 ease-out hover:bg-white focus:outline-none focus:ring-2 focus:ring-gray-300 focus:ring-offset-2 md:left-10 md:top-auto md:bottom-10"
      >
