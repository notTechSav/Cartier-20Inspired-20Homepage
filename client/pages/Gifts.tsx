          ...
          >
            <div
              style={{
                ...
                width: "100%",
                maxWidth: "1120px",
                paddingLeft: "var(--spacer-3xl)",
                paddingRight: "var(--spacer-3xl)",
                paddingBottom: "var(--spacer-3xl)",
              }}
            >
              <div
                style={{ maxWidth: "40rem", textAlign: "left", color: "white" }}
              >
                <p
                  style={{
